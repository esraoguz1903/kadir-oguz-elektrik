...
export const services = [
  {
    ...
    image: "/priz.jpeg",
    detailedDescription: `
      Ev ve iş yerlerinizde meydana gelen her türlü elektrik arızasında yanınızdayız. 
      Eskiyen prizlerin değişimi, çalışmayan anahtarların onarımı, sigorta atması sorunları ve 
      hasarlı kabloların yenilenmesi gibi işlemleri profesyonelce gerçekleştiriyoruz.
      
      Güvenliğiniz bizim önceliğimizdir. Arızalı elektrik tesisatı yangın riski oluşturabilir. 
      Bu yüzden en küçük sorunda bile uzman desteği almanız önemlidir. Kullandığımız malzemeler 
      TSE standartlarına uygun, uzun ömürlü ve garantilidir.
    `,
    features: [
  ...
  },
  {
    ...
    image: "/avize.jpeg",
    detailedDescription: `
      Yeni aldığınız avizelerin montajı veya odalarınızın 
      yerleşim planına göre yeni priz/hat çekilmesi işlemlerini titizlikle yapıyoruz.
      
      Özellikle avize montajı, tavan yapısına uygun dübel seçimi ve elektrik bağlantılarının 
      doğru yapılması açısından uzmanlık gerektirir. Yanlış montaj hem estetik sorunlara hem de 
      düşme riskine yol açabilir. Biz, mekanınıza en uygun ve en sağlam montajı garanti ediyoruz.
    `,
    features: [
  ...
  },
  {
    ...
    detailedDescription: `
      Mekanlarınızın havasını değiştirecek modern aydınlatma çözümleri sunuyoruz. 
      Gizli LED aydınlatmalar, spot ışıklar, bahçe aydınlatmaları ve ofis ışıklandırma sistemleri 
      konusunda uzmanız.
      
      Doğru aydınlatma sadece estetik değil, enerji tasarrufu açısından da önemlidir. 
      Mekanınıza en uygun ışık rengini ve armatürleri seçmenize yardımcı oluyor, 
      elektrik faturanızı düşürecek LED dönüşüm projeleri uyguluyoruz.
    `,
    features: [
